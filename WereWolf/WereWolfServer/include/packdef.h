...
#define _DEF_PORT_UDP   8080
#define _DEF_IP_UDP "192.168.1.38"
#define _DEF_SERVERIP "0.0.0.0"  //TODO

/*-------------数据库信息-----------------*/
#define _DEF_DB_NAME    "WereWolf"
...
//#define _DEF_TIME_NIGHT     5
//#define _DEF_TIME_DAY       5
...
struct STRU_ROUND{
    STRU_ROUND(): type(_DEF_PACK_ROUND), roundNum(0), isNight(true), roleBehavior(0), whoDied(0){
